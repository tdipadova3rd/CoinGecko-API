...
//Helpers
const CoinGecko = require('../src/index');
...
describe('CoinGecko', function () {
  ...
  describe('assetPlatforms', function () {
    describe('all', function () {
      before(function (done) {
        this.CoinGeckoClient.assetPlatforms.all().then((data) => {
          this.data = data;
          done();
        });
      });
  ...
  describe('indexes', function () {
    ...
    describe('fetch', function () {
      before(function (done) {
        this.CoinGeckoClient.indexes.fetch('ftx', 'BTC').then((data) => {
          this.data = data;
          done();
        });
      });
